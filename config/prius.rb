...
Prius.load(:slack_bot_api_token, type: :string)
...
Prius.load(:airbrake_project_id, type: :string)
Prius.load(:airbrake_api_key, type: :string)
Prius.load(:log_path, type: :string, required: false)
Prius.load(:gc_webhook_secret, type: :string)
Prius.load(:port, type: :int)
